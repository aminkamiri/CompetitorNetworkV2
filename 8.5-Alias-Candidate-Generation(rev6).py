# 8.5-Alias-Candidate-Generation(rev6).py
...
def add_candidate_ranking(review):
    ...
    review["_rule_sort"] = review["candidate_match_rule"].apply(lambda value: {"exact_standardized_match": 1, "legal_form_normalization": 2, "suffix_stripped_match": 3, "parent_prefix_recovery": 4}.get(match_rule_base(value), 9))
