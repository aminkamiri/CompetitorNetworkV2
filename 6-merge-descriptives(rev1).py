...
for file in sorted(MAPPED_DIR.glob("*.xlsx")):
    ...
    for col in [STD_COL, CIK_COL, GVKEY_COL, SOURCE_COL, METHOD_COL, BRIDGE_NAME_COL, BRIDGE_ORIGINAL_COL]:
...
wide["list_length_mismatch"] = (
    ...
    (wide["n_competitor_mentions"] != wide["n_matched_bridge_name_entries"]) |
    (wide["n_competitor_mentions"] != wide["n_matched_bridge_original_entries"])
)
...
for source in validation_sources:
    ...
    sample[VALIDATION_COLUMNS].to_csv(
...
high_frequency_parent_global_review.to_csv(
