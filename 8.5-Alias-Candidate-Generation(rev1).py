# 8.5-Alias-Candidate-Generation(rev1).py
...
def add_candidate_ranking(review):
    ...
    for record_id, group in ranked.groupby("record_id", dropna=False):
        ...
        weak_parent_prefix = rule_base == "parent_prefix_recovery" and top["candidate_rank_score"] < 80

        if has_identifier and margin_ok and not weak_parent_prefix:
