# 8.5-Alias-Candidate-Generation(rev8).py
...
def prepare_year_specific_bridge():
    ...
    identity_cols = [
        ...
        "candidate_extension_type", "candidate_in_identifier_year_panel",
...
def add_candidate_ranking(review):
    ...
    review["_rule_sort"] = review["candidate_match_rule"].apply(lambda value: {"exact_standardized_match": 1, "legal_form_normalization": 2, "suffix_stripped_match": 2, "exact_other_year": 3, "legal_other_year": 4, "parent_prefix_recovery": 5}.get(match_rule_base(value), 9))
...
def scenario_status(row, scenario):
    ...
    if scenario == "broad_recall_with_manual_flags":
        return "auto_accept" if tier.startswith(("Tier A auto", "Tier B auto", "Tier C auto", "Tier D auto", "Tier E auto")) else "manual_review"
    return "manual_review"
